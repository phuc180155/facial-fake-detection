...
from model.cnn.srm_two_stream.attention import ChannelAttention, SpatialAttention, DualCrossModalAttention
from model.cnn.srm_two_stream.srm_conv import SRMConv2d_simple, SRMConv2d_Separate
from model.cnn.srm_two_stream.transfermodel import TransferModel
...
class Two_Stream_Net(nn.Module):
    def __init__(self):
        ...
        self.dual_cma0 = DualCrossModalAttention(in_dim=728, size=8, ret_att=False)
        self.dual_cma1 = DualCrossModalAttention(in_dim=728, size=8, ret_att=False)
