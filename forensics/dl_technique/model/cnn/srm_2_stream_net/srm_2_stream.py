...
class Two_Stream_Net(nn.Module):
    def __init__(self, num_classes=1, pretrained='', ret_attn_fea=False):
        super().__init__()
        self.xception_rgb = TransferModel(
            'xception', dropout=0.5, inc=3, num_out_classes=num_classes, return_fea=True, pretrained_path=pretrained)
        ...
        self.att_dic = {}
        self.ret_attn_fea = ret_attn_fea
