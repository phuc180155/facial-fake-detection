...
PRETRAINED_WEIGHT_PATH = '/mnt/disk1/phucnp/Graduation_Thesis/review/forensics/dl_technique/checkpoint/xception-b5690688.pth'
...
class TransferModel(nn.Module):
    ...
    def __init__(self, modelchoice, num_out_classes=1, dropout=0.0,
                 weight_norm=False, return_fea=False, inc=3, pretrained_path=''):
